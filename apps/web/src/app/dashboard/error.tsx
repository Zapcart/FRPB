// FRPB — dashboard segment error boundary.
// Catches unhandled errors inside the /dashboard segment (pages + nested
// components). Database failures in the dashboard layout are already handled by
// the in-layout try/catch banner; this boundary is the safety net for anything
// else. Auth failures (blueprint fix 9) get a "sign in again" action.
...
export default function DashboardError({
  ...
  useEffect(() => {
    ...
    console.error("[frpb:web] Dashboard error:", error);
  }, [error]);
