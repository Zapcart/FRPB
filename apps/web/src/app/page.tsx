  ...
  return (
    <div className="flex min-h-screen flex-col overflow-x-hidden bg-white text-slate-900">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/80 backdrop-blur-xl">
        <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-6">
          ...
          <div className="flex items-center gap-3">
            <Link
              href={downloadUrl}
              className="btn-accent hidden px-4 py-2 text-xs sm:inline-flex md:text-sm"
            >
      ...
      <section className="relative">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-10 pt-20 text-center sm:pt-24">
          <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-brand-100 bg-brand-50/80 px-4 py-1.5 text-xs font-semibold text-brand-700">
            <Sparkles className="h-3.5 w-3.5" />
            FRPB v1.0 — Official Android & iOS Device Utility
          </div>

          <h1 className="mx-auto max-w-4xl text-4xl font-extrabold leading-[1.08] tracking-tight text-ink sm:text-6xl">
            All in One & One for All —{" "}
            <span className="bg-gradient-to-r from-brand-600 via-brand-500 to-accent-500 bg-clip-text text-transparent">
              Professional Device Recovery
            </span>
          </h1>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-slate-500 sm:text-lg">
            ...
            firmware, install OEM drivers and manage your devices — now with full support for{" "}
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              href={downloadUrl}
              className="btn-accent w-full px-7 py-3.5 text-base shadow-blue-glow sm:w-auto"
            >
              <Download className="h-5 w-5" />
              Download for Windows
            </Link>
            <Link href="#pricing" className="btn-ghost w-full px-7 py-3.5 text-base sm:w-auto">
              See Pricing
          ...
          <p className="mt-4 text-xs text-slate-400">
            Windows 10/11 · Free trial available · No credit card required
          </p>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2.5 text-sm">
                {[
                  ...
                  { label: "Privacy Policy", href: "#eula" },
                  { label: "Refund Policy", href: "#eula" },
                ].map((item) => (
                  <li key={item.label}>
                    <Link
                      href={item.href}
